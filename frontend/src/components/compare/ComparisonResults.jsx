...
const ComparisonResults = ({ 
  ...
  const { car1, car2 } = comparisonData
      ...
      >
        ...
        >
          ...
          <div className="mt-1 sm:mt-2 px-1">
            <OnRoadPriceDisplay
              exShowroomPrice={car1.onRoadPricing?.exShowroomPrice}
              exShowroomPriceLabel={car1.price}
              onRoadPricing={car1.onRoadPricing}
              isDark={isDark}
              size="compact"
            />
          </div>
        ...
        >
          ...
          <div className="mt-1 sm:mt-2 px-1">
            <OnRoadPriceDisplay
              exShowroomPrice={car2.onRoadPricing?.exShowroomPrice}
              exShowroomPriceLabel={car2.price}
              onRoadPricing={car2.onRoadPricing}
              isDark={isDark}
              size="compact"
            />
          </div>
